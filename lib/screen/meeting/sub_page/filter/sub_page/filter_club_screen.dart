...
class FilterClubScreen extends StatefulWidget{
  @override
  State<FilterClubScreen> createState() => FilterClubScreenState();
}

class FilterClubScreenState extends State<FilterClubScreen> {
