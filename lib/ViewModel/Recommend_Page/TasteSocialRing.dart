...
class TasteSocialRing_Provider extends ChangeNotifier{
  ...
  void set_tasteclub(){
    _tasteclub.add(TasteSocialRing('assets/images/recommend_page/TasteSocialRing/furniture.jpeg', false, ['가구 구경'], '가구 싸게 사는 방법 알려드려요', '인천시', '10.21(토) 오후: 1:00', 10, 15));
    _tasteclub.add(TasteSocialRing('assets/images/recommend_page/TasteSocialRing/intestines.jpeg', false, ['음식'], '불금에 같이 곱창 먹어요', '서울시 은평구', '10.20(금) 오후: 6:00', 7, 12));
    _tasteclub.add(TasteSocialRing('assets/images/recommend_page/TasteSocialRing/island.jpeg', false, ['여행', '추천'], '울릉도로 떠나요', '목포시', '10.21(토) 오전: 8:00', 8, 10));
  }
