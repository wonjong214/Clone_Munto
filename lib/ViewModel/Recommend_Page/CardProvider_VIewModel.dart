...
class Card_Provider extends ChangeNotifier{
  ...
  void set_card(){
    ...
    Card_Model model3 = Card_Model(
      writerimage: 'assets/images/recommend_page/Review/burger.jpeg',
      writername: '김상진',
      writedate: '11월 12일',
      pageviewimage: ['assets/images/socialring/foodstreet.jpg', 'assets/images/socialring/beer.jpg', 'assets/images/recommend_page/Review/burger.jpeg'],
      meetingimage: 'assets/images/recommend_page/Review/ski.jpeg',
      meetingtitle: '점심부터 저녁까지 배 터질때까지 먹어봐요',
      meetingtype: '소셜링',
      meetinglocation: '강남구',
      meetingtime: '11.11(토) 오후 2:00',
      maplocation: '강남역',
      mapdetaillocation: '서울특별시 강남구 강남대로 396',
      bodytext: '멤버분들과 여러 맛집을 돌아다니며 속깊은 애기를 하면서 더 친해진 것 같아 너무 좋았어요',
      tag: ['맛집', '음식', '맥주', '멤버', '푸드파이트', '소셜링후기'],
      like: false,
      likenum: 7,
      chatnum: 0,
      chatimage: '',
    ...
    _card.add(Card_ViewModel(card_model: model1));
    _card.add(Card_ViewModel(card_model: model2));
