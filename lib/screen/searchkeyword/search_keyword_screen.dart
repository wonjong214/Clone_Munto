          ...
          bottom: PreferredSize(
              ...
              child: Align(
                ...
                child: TabBar(
                  ...
                  tabs: [
                    Tab(child: Text('소셜링', style: TextStyle(fontSize: 15), maxLines: 1,)),
                    Tab(child: Text('클럽', style: TextStyle(fontSize: 15))),
                    Tab(child: Text('챌린지', style: TextStyle(fontSize: 15), maxLines: 1,)),
                    Tab(child: Text('피드', style: TextStyle(fontSize: 15))),
                    Tab(child: Text('멤버', style: TextStyle(fontSize: 15))),
                  ],
